...
public class WebApiMethods
{
    ...
    public static async Task<(string, string, string)> AuthenticateClientAndUser(ViewModels.LoginViewModel loginUser)
    {
        ...
        var request = new OpenIddictClientModels.PasswordAuthenticationRequest
        {
            ...
            Scopes = new List<string>() { "openid", Scopes.OfflineAccess }
        };
    ...
    public static async Task<List<ViewModels.LoginViewModel>> GetUsersAsync(string token)
    {
        ...
        var loginUsers = JsonSerializer.Deserialize<List<ViewModels.LoginViewModel>>(resultJsonString.Replace("login", "Login").Replace("password", "Password"));

        return loginUsers ?? new List<ViewModels.LoginViewModel>();
    }

    public static async Task<ViewModels.LoginViewModel> CreateUserAsync(ViewModels.LoginViewModel loginUser)
    {
        using var client = Provider.GetRequiredService<HttpClient>();
